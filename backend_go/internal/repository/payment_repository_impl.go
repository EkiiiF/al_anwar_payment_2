...
// PaymentRepositoryImpl — implementasi PaymentRepository.
type PaymentRepositoryImpl struct{}

// NewPaymentRepository — konstruktor PaymentRepository.
...
func (r *PaymentRepositoryImpl) FindInvoiceByID(db *gorm.DB, id string) (domain.Invoice, error) {
	...
	err := db.Preload("Student").Preload("Student.Guardians").Preload("Category", func(db *gorm.DB) *gorm.DB { return db.Unscoped() }).
